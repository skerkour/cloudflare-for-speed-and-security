  ...
  <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <p class="rounded-lg bg-blue-50 p-4 mb-3 text-blue">
        Use the following credentials to log into the demo: <br />
        <b>email:</b> readers@cloudflarebook.com <br />
        <b>password:</b> W3CqNrR3L6GRNSH95qcJDjHxZy3bnRvg <br />
      </p>
      ...
      <!-- <form class="space-y-6" action="#" method="POST"> -->
        ...
        <div class="flex items-center justify-between">
          <div class="text-sm">
            <RouterLink class="font-medium text-indigo-600 hover:text-indigo-500" to="/signup">
        ...
        <div>
          <CfButton @click="login" :loading="loading" class="w-full">
            Log in
          </CfButton>
        </div>
      <!-- </form> -->
...
const email = ref('readers@cloudflarebook.com');
const password = ref('');
...
async function login() {
  ...
  try {
    await api.login($apiClient, input);
